...
public class DawWindowTitleTests
{
    ...
    [TestCase("AnotherProject - Bitwig Studio - ", "AnotherProject - ")]
    [TestCase("Bitwig Studio - New 1", "New 1")]
    [TestCase("Bitwig Studio - Untitled", "Untitled")]
    ...
    [TestCase("Sonar - MyProject", "MyProject")]
    [TestCase("Sonar - MyProject*", "MyProject*")]
